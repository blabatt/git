...
\textit{Moves HEAD to a named branch or SHA commit. A Swiss-army knife tool. Prefer more targeted tools like }\code{git switch}\textit{ when possible.}\\%You cannot checkout a branch that clashes with changes in your working directory.}\\
